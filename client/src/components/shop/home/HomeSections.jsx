    ...
    <>
      <section className="hero" id="hero">
        ...
        <div className="container hero-content">
          ...
          <Link to={brand.cta.href} className="btn btn-primary">
            {brand.cta.label}
          </Link>
        </div>
      </section>
        ...
        <div className="container collection-grid">
          {infoBoxes.map((box) => (
            <div className="info-box" key={box.title}>
              <div className="info-box-image" style={{ backgroundImage: `url(${box.image})` }} />
              <div className="info-box-content">
                <h3>{box.title}</h3>
                <p>{box.description}</p>
                <Link to={box.actionHref} className="btn btn-primary">
                  {box.actionLabel}
                </Link>
              </div>
            </div>
